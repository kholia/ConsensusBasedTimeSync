...
void setup()
{
  ...
  si5351.drive_strength(SI5351_CLK1, SI5351_DRIVE_8MA); // Do NOT set reduced power for RX!
  si5351.drive_strength(SI5351_CLK2, SI5351_DRIVE_8MA);

  // 20m
  int F_FT8 = 14074000;
  // int F_WSPR = 14095600;
  ifreq = 446500ULL; // works for 10m

  si5351.set_freq(28074000ULL * 100ULL, SI5351_CLK1);
  si5351.set_freq(ifreq * 100ULL, SI5351_CLK2);
  si5351.output_enable(SI5351_CLK0, 0); // TX off
  si5351.output_enable(SI5351_CLK1, 1); // RX on
  si5351.output_enable(SI5351_CLK2, 1); // RX IF on

  // ATTENTION: Use the following loop to brute-force the "BFO frequency" value!
  for (unsigned long long ifreq_= 420000ULL; ifreq_ <= 475000ULL; ifreq_ += 500ULL) {
      si5351.set_freq(ifreq_ * 100ULL, SI5351_CLK2);
      Serial.println(ifreq_);
      delay(5000);
  }
}
